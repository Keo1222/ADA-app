...
if not exist %WRAPPER_JAR% (
    echo. 1>&2
    echo ERROR: Gradle wrapper jar not found. 1>&2
    echo Please run: gradle wrapper --gradle-version 8.4 1>&2
    echo Or use Android Studio to build the project. 1>&2
    goto fail
)
...
rem having to exit the command line. This may cause unexpected behavior.
